package com.greenfoxacademy.patientpatientapp;
...
public class DoctorsOfficeServiceImplTest {
  ...
  public void init(){
    ...
    testDoctor1 = new ApplicationUser("Dr Duna", "testPassword", "admin", "testEmail@drduna.com");
    testDoctor2 = new ApplicationUser("Dr Tisza", "testPassword", "admin", "testEmail@drtisza.com");
  ...
  public void saveDoctorsOffice_exsisting_throwsException() throws DoctorsOfficeException {
    when(doctorsOfficeRepository.findByAddress(testDoctorsOffice1.getAddress())).thenReturn(testDoctorsOffice1);
  ...
  public void saveDoctorsOffice_ableToSave() throws DoctorsOfficeException {
    ...
    assertEquals(testDoctorsOffice1.getAddress(), doctorsOfficeServiceImpl.saveDoctorsOffice(testDoctorsOffice1).getAddress());
  }
